...
#define SEVEN_SEGMENT_LEFT_PINA   PIN4
#define SEVEN_SEGMENT_LEFT_PINB   PIN5
#define SEVEN_SEGMENT_LEFT_PINC   PIN6
#define SEVEN_SEGMENT_LEFT_PIND   PIN7

#define SEVEN_SEGMENT_RIGHT_PORT  DIO_PORTC
#define SEVEN_SEGMENT_RIGHT_PINA   PIN4
#define SEVEN_SEGMENT_RIGHT_PINB   PIN5
#define SEVEN_SEGMENT_RIGHT_PINC   PIN6
#define SEVEN_SEGMENT_RIGHT_PIND   PIN7
